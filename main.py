...
class Train:
    def __init__(self, model_name="bert", method_name="sentibert"):
        self.logger = logger
        self.micro_f1 = MulticlassF1Score(task="multiclass", num_classes=num_classes, average="micro").to(device)
        self.macro_f1 = MulticlassF1Score(task="multiclass", num_classes=num_classes, average="macro").to(device)
